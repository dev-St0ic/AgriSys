...
class BoatrRegisteredSeeder extends Seeder
{
     ...
     *
     * HP values are taken directly from raw spreadsheet (no rounding).
     * FishR numbers are taken exactly as written in the spreadsheet.
     */
    public function run(): void
    {
        ...
        $boatData = [
            ...
            // TD raw: 0.60 (RD=3.66 is a data-entry error in raw spreadsheet)
            ...
            // FishR raw: 'LG SP-000324-2017' (no hyphen after LG — exactly as spreadsheet)
            ...
            // HP raw: 7.5 | TB raw from TL column: 0.73 (RB=2.5 is data entry error)
