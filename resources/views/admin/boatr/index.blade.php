...
@section('content')
                    ...
                    <div class="row g-3">
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="search" class="form-control border-start-0"
                                    placeholder="🔍 Search name, vessel, FishR number..." 
                        ...
                        <div class="col-md-2">
                            <select name="status" class="form-select" onchange="submitFilterForm()">
                                ...
                                <option value="inspection_required" {{ request('status') == 'inspection_required' ? 'selected' : '' }}>
                                    🔍 Inspection Required
                                </option>
                                <option value="inspection_scheduled" {{ request('status') == 'inspection_scheduled' ? 'selected' : '' }}>
                        ...
                        <div class="col-md-2">
                            <select name="boat_type" class="form-select" onchange="submitFilterForm()">
                                ...
                                <option value="Rake Stem - Rake Stern" {{ request('boat_type') == 'Rake Stem - Rake Stern' ? 'selected' : '' }}>
                                    Rake Stem - Rake Stern
                                </option>
                                <option value="Rake Stem - Transom/Spoon/Plumb Stern" {{ request('boat_type') == 'Rake Stem - Transom/Spoon/Plumb Stern' ? 'selected' : '' }}>
                                    Rake Stem - Transom
                                </option>
                                <option value="Skiff (Typical Design)" {{ request('boat_type') == 'Skiff (Typical Design)' ? 'selected' : '' }}>
                                    Skiff (Typical Design)
                                </option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            <select name="primary_fishing_gear" class="form-select" onchange="submitFilterForm()">
                                <option value="">🎣 All Fishing Gear</option>
                                <option value="Hook and Line" {{ request('primary_fishing_gear') == 'Hook and Line' ? 'selected' : '' }}>
                                    Hook and Line
                                </option>
                                <option value="Bottom Set Gill Net" {{ request('primary_fishing_gear') == 'Bottom Set Gill Net' ? 'selected' : '' }}>
                                    Bottom Set Gill Net
                                </option>
                                <option value="Fish Trap" {{ request('primary_fishing_gear') == 'Fish Trap' ? 'selected' : '' }}>
                                    Fish Trap
                                </option>
                                <option value="Fish Coral" {{ request('primary_fishing_gear') == 'Fish Coral' ? 'selected' : '' }}>
                                    Fish Coral
                                </option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <div class="btn-group w-100" role="group">
                                ...
                                <a href="{{ route('admin.boatr.requests') }}" class="btn btn-outline-secondary">
                    ...
                    <tbody>
                        @forelse($registrations as $registration)
                            <tr id="registration-{{ $registration->id }}">
                                ...
                                <td>{{ $registration->boat_dimensions }}</td>
                                <td>{{ $registration->engine_horsepower }} HP</td>
                                <td>
                                    <span class="badge bg-{{ $registration->status_color }}" id="status-badge-{{ $registration->id }}">
                                        {{ $registration->formatted_status }}
                                    </span>
                                </td>
                                <td>
                                    @if($registration->inspection_completed)
                                        <span class="badge bg-success" id="inspection-badge-{{ $registration->id }}">Completed</span>
                                    @else
                                        <span class="badge bg-warning" id="inspection-badge-{{ $registration->id }}">Pending</span>
                                    @endif
                                </td>
                                <td>
                                    @php
                                    ...
                                    <div id="documents-cell-{{ $registration->id }}">
                                        @if($totalDocs > 0)
                                            <button class="btn btn-sm btn-info" onclick="viewDocuments({{ $registration->id }})">
                                ...
                                <td>
                                    <div class="btn-group" id="actions-{{ $registration->id }}">
                                        <button class="btn btn-sm btn-primary" onclick="viewRegistration({{ $registration->id }})" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button class="btn btn-sm btn-warning" onclick="showUpdateModal({{ $registration->id }}, '{{ $registration->status }}')" title="Update Status">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        @if(!$registration->inspection_completed)
                                            <button class="btn btn-sm btn-success" onclick="showInspectionModal({{ $registration->id }})" title="Complete Inspection">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="updateStatusBtn" onclick="updateRegistrationStatus()" style="display: none;">
    ...
    <div class="modal fade" id="inspectionModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-success" id="completeInspectionBtn" onclick="completeInspection()">
    ...
    <div class="toast-container position-fixed top-0 end-0 p-3" style="z-index: 9999;">
        <div id="actionToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="true" data-bs-delay="5000">
...
<script>
    ...
    function updateRegistrationStatus() {
        ...
        if (!confirm(`Are you sure you want to change the status to "${document.querySelector(`#newStatus option[value="${newStatus}"]`).textContent}"?`)) {
            return;
        }
