...
@section('page-icon', 'fas fa-chalkboard-teacher')
@section('page-title', 'Training Requests')
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control form-control-sm"
                                placeholder="Search name, number..." value="{{ request('search') }}" oninput="autoSearch()"
                                id="searchInput">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item"
                                href="{{ route('admin.training.export', array_merge(request()->query(), ['format' => 'csv'])) }}">
                                <i class="fas fa-file-csv me-2 text-success"></i>Download CSV
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                                href="{{ route('admin.training.export', array_merge(request()->query(), ['format' => 'excel'])) }}">
                                <i class="fas fa-file-excel me-2 text-success"></i>Download Excel
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                                href="{{ route('admin.training.export', array_merge(request()->query(), ['format' => 'pdf'])) }}">
                        ...
                        @forelse($trainings as $training)
                            <tr data-application-id="{{ $training->id }}">
                                <td class="text-center align-middle">
                                    <input type="checkbox" class="bulk-checkbox" value="{{ $training->id }}"
                        ...
                        <div class="card border-0 bg-light">
                            ...
                            <div class="card-body">
                                ...
                                <textarea class="form-control" id="training_remarks" rows="4"
                                    placeholder="Add any comments about this request..." maxlength="1000" oninput="updateTrainingRemarksCounter()"></textarea>
                                <div class="d-flex justify-content-between align-items-center mt-2">
                                    <small class="text-muted">
                                        <i class="fas fa-info-circle me-1"></i>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-danger" role="alert">
                        ...
                        <p class="mb-0">Are you sure you want to delete this Training Request? <strong
                                id="delete_training_name"></strong> will be moved to the Recycle Bin.</p>
                    </div>
                    <ul class="mb-0">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group">
                                    <input type="file" class="form-control" id="import_file_input"
                                        accept=".csv,.xlsx,.xls,.txt" onchange="onImportFileSelected(this)">
                                    <button class="btn btn-warning" type="button" onclick="submitImport()"
                                        id="importSubmitBtn" disabled
                                        data-import-url="{{ route('admin.training.import') }}">
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="button" class="btn btn-success" id="importDoneBtn" style="display:none;"
    ...
    <script>
        ...
        function validateEditTrainingForm() {
            ...
            const requiredFields = [{
                ...
                {
                    id: 'edit_training_contact_number',
                    label: 'Contact Number'
                },
                {
        ...
        function handleEditTrainingSubmit() {
            ...
            const fields = ['first_name', 'middle_name', 'last_name', 'name_extension', 'contact_number', 'barangay',
                'training_type'
            ];
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (highlightId) {
                setTimeout(() => {
                    const row = document.querySelector(`tr[data-application-id="${highlightId}"]`);
                    if (row) {
                        // Scroll to the row
                        row.scrollIntoView({
                            behavior: 'smooth',
