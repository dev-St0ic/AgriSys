        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-0">RSBSA Analytics Dashboard</h4>
...
<div class="tab-content" id="serviceTabContent">
    ...
    <div class="tab-pane fade show active" id="rsbsa-service" role="tabpanel">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.analytics.rsbsa') }}" class="row g-3">
                            ...
                            <div class="col-md-6 d-flex align-items-end">
                                ...
                                <button type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#rsbsaInsightsModal">
        ...
        <div class="row mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <small class="opacity-75">
                                    <i class="fas fa-arrow-up me-1"></i>{{ $overview['unique_applicants'] }} farmers registered
                                </small>
                            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%);">
                    <div class="card-body text-white">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h6 class="card-title mb-2 opacity-75">Land Area Coverage</h6>
                                <h2 class="mb-1">{{ number_format($overview['total_land_area'], 1) }}</h2>
                                <small class="opacity-75">hectares across {{ $overview['active_barangays'] }} barangays</small>
                            </div>
                            <div class="p-3 bg-white bg-opacity-20 rounded-circle">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <div class="d-flex align-items-center p-3 rounded" style="background: linear-gradient(90deg, rgba(34, 197, 94, 0.1) 0%, rgba(34, 197, 94, 0.05) 100%);">
                                    <div class="me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="progress mb-1" style="height: 6px;">
                                            <div class="progress-bar bg-success" 
                                                 style="width: {{ ($commodity->total_applications / $commodityAnalysis->first()->total_applications) * 100 }}%"></div>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <small class="text-muted">{{ $commodity->total_applications }} farmers</small>
                                            <small class="text-success">{{ round($commodity->total_land_area, 1) }}ha total</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row text-center">
                            <div class="col-6">
                                <div class="p-3 rounded bg-light">
                                    <h4 class="text-primary mb-1">{{ number_format($overview['total_land_area'], 1) }}</h4>
                                    <p class="mb-0 text-muted">Total Hectares</p>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="p-3 rounded bg-light">
                                    <h4 class="text-warning mb-1">{{ number_format($overview['avg_land_area'], 2) }}</h4>
                            ...
                            <div class="col-6">
                                <div class="p-3 rounded" style="background: rgba({{ $gender->sex === 'Male' ? '59, 130, 246' : '236, 72, 153' }}, 0.1);">
                                    ...
                                    <small class="text-{{ $gender->sex === 'Male' ? 'primary' : 'pink' }}">
                                        {{ $genderAnalysis['percentages'][$gender->sex] ?? 0 }}% | {{ round($gender->total_land_area, 1) }}ha
                                    </small>
                                </div>
                            </div>
                            @endforeach
                    ...
                    <div class="card-body">
                        ...
                        <div class="metric-item mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="badge bg-success">{{ number_format($performanceMetrics['total_land_impact'], 1) }}ha</span>
                            </div>
                            <div class="progress mb-1" style="height: 8px;">
                                <div class="progress-bar bg-success" 
                                     style="width: {{ min(100, $performanceMetrics['total_land_impact'] / 1000 * 100) }}%"></div>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-gradient-success text-white">
                        <h5 class="mb-0">
                            <i class="fas fa-crown me-2"></i>Top Farmers by Land Area
                        </h5>
                    </div>
                    <div class="card-body">
                        @foreach($landAreaAnalysis['top_farmers']->take(8) as $index => $farmer)
                        <div class="d-flex justify-content-between align-items-center mb-2 p-2 rounded hover-bg-light">
                            <div class="d-flex align-items-center">
                                <div class="badge bg-{{ $index < 3 ? 'warning' : 'secondary' }} rounded-pill me-3">
                                    {{ $index + 1 }}
                                </div>
                                <div>
                                    <h6 class="mb-0">{{ $farmer->full_name }}</h6>
                                    <small class="text-muted">{{ $farmer->barangay }} • {{ ucfirst($farmer->commodity) }}</small>
                                </div>
                            </div>
                            <div class="text-end">
                                <span class="badge bg-success">{{ $farmer->land_area }}ha</span>
                                <br>
                                <span class="badge bg-{{ $farmer->status === 'approved' ? 'success' : ($farmer->status === 'rejected' ? 'danger' : 'warning') }} mt-1">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-gradient-primary text-white">
                        <h5 class="mb-0">
                            <i class="fas fa-calendar-week me-2"></i>Registration by Day of Week
                        </h5>
                    </div>
                    <div class="card-body">
                        <canvas id="rsbsaDayOfWeekChart" height="200"></canvas>
                        <div class="mt-3">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-gradient-info text-white">
                        <h5 class="mb-0">
                            <i class="fas fa-clock me-2"></i>Registration by Hour of Day
                        </h5>
                    </div>
                    <div class="card-body">
                        <canvas id="rsbsaHourlyChart" height="200"></canvas>
                        <div class="mt-3">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <h6 class="text-info">Peak Hours</h6>
                                    <small class="text-muted">
                                        {{ $registrationPatterns['hourly']->sortByDesc('applications_count')->first()->hour ?? 'N/A' }}:00 - 
                                        {{ ($registrationPatterns['hourly']->sortByDesc('applications_count')->first()->hour ?? 0) + 1 }}:00
                                    </small>
                                </div>
                                <div class="col-4 text-center">
                                    <h6 class="text-success">Most Active</h6>
                                    <small class="text-muted">
                                        {{ $registrationPatterns['hourly']->sortByDesc('applications_count')->first()->applications_count ?? 0 }} apps
                                    </small>
                                </div>
                                <div class="col-4 text-center">
                                    <h6 class="text-warning">Least Active</h6>
                                    <small class="text-muted">
                                        {{ $registrationPatterns['hourly']->sortBy('applications_count')->first()->applications_count ?? 0 }} apps
                                    </small>
                                </div>
                            </div>
                        </div>
...
<!-- AI Insights Modal -->
<div class="modal fade" id="rsbsaInsightsModal" tabindex="-1" aria-labelledby="rsbsaInsightsModalLabel" aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-info">
                            ...
                            <ul class="mb-0">
                                <li><strong>Approval Efficiency:</strong> Current approval rate of {{ $overview['approval_rate'] }}% 
                                    {{ $overview['approval_rate'] > 80 ? 'indicates excellent processing efficiency' : ($overview['approval_rate'] > 60 ? 'shows good performance with room for improvement' : 'suggests need for process optimization') }}</li>
                                <li><strong>Agricultural Impact:</strong> {{ number_format($overview['total_land_area'], 1) }} hectares under RSBSA registration represents significant agricultural coverage</li>
                                <li><strong>Document Compliance:</strong> {{ $documentAnalysis['submission_rate'] }}% document submission rate 
                                    {{ $documentAnalysis['submission_rate'] > 70 ? 'shows good farmer compliance' : 'indicates need for better guidance on documentation' }}</li>
                            </ul>
                        </div>
                        ...
                        <div class="alert alert-success">
                            ...
                            <ul class="mb-0">
                                <li><strong>Crop Diversity:</strong> {{ $overview['unique_commodities'] }} different commodities registered shows 
                                    {{ $overview['unique_commodities'] > 10 ? 'excellent agricultural diversification' : 'moderate crop variety' }}</li>
                                <li><strong>Land Utilization:</strong> Average {{ number_format($overview['avg_land_area'], 2) }} hectares per farmer indicates 
                                    {{ $overview['avg_land_area'] > 2 ? 'larger scale farming operations' : 'small-scale agricultural practices' }}</li>
                                <li><strong>Geographic Coverage:</strong> {{ $overview['active_barangays'] }} barangays participating demonstrates wide program reach</li>
                            </ul>
                        </div>
                        ...
                        <div class="alert alert-warning">
                            ...
                            <ul class="mb-0">
                                ...
                                <li><strong>Processing Time:</strong> Average {{ $processingTimeAnalysis['avg_processing_days'] }} days processing time could be improved through workflow optimization</li>
                                @endif
                                @if($documentAnalysis['submission_rate'] < 70)
                                <li><strong>Documentation:</strong> Consider implementing better guidance systems to improve {{ $documentAnalysis['submission_rate'] }}% document submission rate</li>
                                @endif
                                <li><strong>Outreach:</strong> Focus on underperforming barangays to improve overall program participation</li>
                                <li><strong>Support:</strong> Provide targeted assistance to farmers with smaller land areas to maximize agricultural productivity</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    .metric-item .progress { border-radius: 10px; }
