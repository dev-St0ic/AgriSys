            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        <h4 class="fw-bold mb-2">User Registration Analytics Dashboard</h4>
            ...
            <div class="card metric-card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <h6 class="metric-label text-muted mb-2">Total Registrations</h6>
                            <h2 class="metric-value mb-1">{{ number_format($overview['total_registrations']) }}</h2>
                            <p class="text-muted mb-0 small"><i
                                    class="fas fa-map-marker-alt me-1"></i>{{ $overview['active_barangays'] }} barangays
                            </p>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <p class="text-muted mb-0 small">{{ number_format($overview['approved_registrations']) }}
                                approved</p>
                        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card metric-card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <h6 class="metric-label text-muted mb-2">Email Verification</h6>
                            <h2 class="metric-value mb-1">{{ $overview['email_verification_rate'] }}%</h2>
                            <p class="text-muted mb-0 small">{{ number_format($overview['email_verified']) }} verified</p>
                        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card metric-card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <h6 class="metric-label text-muted mb-2">Document Completion</h6>
                            <h2 class="metric-value mb-1">{{ $overview['document_completion_rate'] }}%</h2>
                            <p class="text-muted mb-0 small">{{ number_format($overview['with_all_documents']) }} complete
                            </p>
                        </div>
                        <div class="metric-icon bg-warning-soft">
                            <i class="fas fa-file-circle-check text-warning"></i>
                        </div>
                    </div>
                </div>
            </div>
