...
@section('page-title', 'User Management Analytics Dashboard')
    ...
    <div class="row mb-4">
        <div class="col-12">
            @include('admin.analytics.partials.filter', [
                'filterRoute' => 'admin.analytics.user-registration',
                'exportRoute' => 'admin.analytics.user-registration.export',
            ])
        </div>
    </div>
