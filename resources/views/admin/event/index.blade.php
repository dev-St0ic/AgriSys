...
@section('content')
                                ...
                                <tr class="event-row" data-category="{{ $event->category }}">
                                   ...
                                   <td>
                                        @php
                                            ...
                                            $color = $categoryColors[$event->category] ?? 'primary';
                                        @endphp
                                    ...
                                    <td>
                                        <input type="number" class="form-control form-control-sm"
                                            ...
                                            onchange="updateEventOrder({{ $event->id }}, this.value)">
                                    </td>
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <button class="btn btn-{{ $event->is_active ? 'warning' : 'success' }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="date" class="form-control"
                                placeholder="e.g., November 15, 2025 | 6:00 AM - 10:00 AM">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Recommended: 400x250px, max 2MB</small>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" class="form-control form-control-sm detail-key"
                                            placeholder="Detail name (e.g., 'Participants')">
                                    </div>
                                    <div class="col-md-6">
    ...
    `;
        ...
        document.getElementById('createEventForm').addEventListener('submit', async function(e) {
            ...
            try {
                document.querySelector('#createEventForm button[type="submit"] .btn-text').style.display = 'none';
                document.querySelector('#createEventForm button[type="submit"] .btn-loader').style.display =
                    'inline';
                ...
                document.querySelector('#createEventForm button[type="submit"] .btn-text').style.display =
                    'inline';
                document.querySelector('#createEventForm button[type="submit"] .btn-loader').style.display = 'none';
            }
        });
        ...
        document.getElementById('editEventForm').addEventListener('submit', async function(e) {
            ...
            try {
                document.querySelector('#editEventForm button[type="submit"] .btn-text').style.display = 'none';
                document.querySelector('#editEventForm button[type="submit"] .btn-loader').style.display =
                    'inline';
                ...
                document.querySelector('#editEventForm button[type="submit"] .btn-text').style.display =
                    'inline';
                document.querySelector('#editEventForm button[type="submit"] .btn-loader').style.display = 'none';
            }
        });
