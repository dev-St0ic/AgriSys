...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Pagination -->
        <nav aria-label="Pagination" class="d-flex justify-content-center mt-4" id="paginationContainer"
            style="display: none;">
    ...
    `;
            toast.innerHTML =
                `<i class="${config.icon}" style="color: ${config.color}; font-size: 1.5rem;"></i><span>${message}</span>`;
