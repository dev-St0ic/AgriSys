                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.inventory.store') }}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('category') is-invalid @enderror" id="category"
                                        ...
                                        <option value="vegetables" {{ old('category') == 'vegetables' ? 'selected' : '' }}>
                                            Vegetables</option>
                                        <option value="fruits" {{ old('category') == 'fruits' ? 'selected' : '' }}>Fruits
                                        </option>
                                        <option value="fertilizers"
                                            {{ old('category') == 'fertilizers' ? 'selected' : '' }}>Fertilizers</option>
                                    </select>
                                    @error('category')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" id="unit"
                                        ...
                                        <option value="kg" {{ old('unit') == 'kg' ? 'selected' : '' }}>Kilograms
                                        </option>
                                        <option value="grams" {{ old('unit') == 'grams' ? 'selected' : '' }}>Grams
                                        </option>
                                        <option value="sacks" {{ old('unit') == 'sacks' ? 'selected' : '' }}>Sacks
                                        </option>
                                        <option value="liters" {{ old('unit') == 'liters' ? 'selected' : '' }}>Liters
                                        </option>
                                        <option value="bottles" {{ old('unit') == 'bottles' ? 'selected' : '' }}>Bottles
                                        </option>
                                        <option value="packs" {{ old('unit') == 'packs' ? 'selected' : '' }}>Packs
                                        </option>
                                    </select>
                                    @error('unit')
                                        <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label for="current_stock" class="form-label">Current Stock <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label for="minimum_stock" class="form-label">Minimum Stock <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label for="maximum_stock" class="form-label">Maximum Stock <span
                                            class="text-danger">*</span></label>
                                    <input type="number"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('last_restocked', date('Y-m-d')) }}">
