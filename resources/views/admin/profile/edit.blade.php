                ...
                <form id="profileForm" action="{{ route('admin.profile.update') }}" method="POST"
                    ...
                    <div class="row g-4">
                                    ...
                                    <div class="position-relative d-inline-block mb-4">
                                        ...
                                        @else
                                            <div class="rounded-circle bg-light d-flex align-items-center justify-content-center text-secondary fw-bold"
                                                style="width: 150px; height: 150px; font-size: 56px; border: 4px solid #f0f0f0;"
                                                id="profilePreview">
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body p-4">
                                    ...
                                    <div>
                                        ...
                                        <strong
                                            class="d-block">{{ $user->updated_at->format('M d, Y \a\t g:i A') }}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card border-0 shadow-sm mb-4">
                                <div class="card-body p-4">
                                    <h6 class="fw-semibold mb-4"><i
                                            class="fas fa-user-circle me-2 text-primary"></i>Personal Information</h6>

                                    <div class="row g-3">
                                        <!-- Full Name -->
                                        <div class="col-12">
                                            <label for="name" class="form-label"><i
                                                    class="fas fa-user me-2 text-muted"></i>Full Name</label>
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                id="name" name="name" value="{{ old('name', $user->name) }}"
                                                required onkeyup="autoCapitalizeName()">
                                            @error('name')
                                        ...
                                        <div class="col-12">
                                            <label for="email" class="form-label"><i
                                                    class="fas fa-envelope me-2 text-muted"></i>Email Address</label>
                                            <input type="email"
                                        ...
                                        <div class="col-12" id="email-password-group" style="display: none;">
                                            <div class="alert alert-warning">
                                                ...
                                                <strong>Email Change Detected:</strong> Please enter your current password
                                                to confirm this change.
                                            </div>
                                            <label for="email_change_password" class="form-label">
                                                <i class="fas fa-key me-2 text-muted"></i>Current Password <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="input-group">
                                                <input type="password"
                                                    class="form-control @error('email_change_password') is-invalid @enderror"
                                            ...
                                            <small class="text-muted d-block mt-2">
                                                <i class="fas fa-info-circle me-1"></i>Required to confirm email change for
                                                security
                                            </small>
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body p-4">
                                    <h6 class="fw-semibold mb-2"><i class="fas fa-lock me-2 text-primary"></i>Change
                                        Password</h6>
                                    <small class="text-muted d-block mb-3">Leave blank if you don't want to change your
                                        password</small>

                                    <div class="alert alert-info mb-4">
                                        <i class="fas fa-envelope-open-text me-2"></i>
                                        <strong>Email Verification Required:</strong> When you change your password, a
                                        verification email will be sent. Your password will only be updated after you click
                                    ...
                                    <div class="row g-3">
                                        <!-- Current Password -->
                                        <div class="col-12">
                                            <label for="current_password" class="form-label"><i
                                                    class="fas fa-key me-2 text-muted"></i>Current Password</label>
                                            <div class="input-group">
                                                <input type="password"
                                        ...
                                        <div class="col-12">
                                            <label for="password" class="form-label"><i
                                                    class="fas fa-lock me-2 text-muted"></i>New Password</label>
                                            <div class="input-group">
                                                <input type="password"
                                            ...
                                            <small class="text-muted d-block mt-2">
                                                <i class="fas fa-info-circle me-1"></i>Must contain at least 8 characters,
                                                including uppercase, numbers, and symbols
                                            </small>
                                            @error('password')
                                                <div class="text-danger mt-2">
                                                    <small><i
                                        ...
                                        <div class="col-12">
                                            <label for="password_confirmation" class="form-label"><i
                                                    class="fas fa-check-circle me-2 text-muted"></i>Confirm New
                                                Password</label>
                                            <div class="input-group">
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    if (preview.tagName === 'IMG') {
                        ...
                        img.style.cssText =
                        'width: 150px; height: 150px; object-fit: cover; border: 4px solid #f0f0f0;';
            ...
            if (form && submitBtn) {
                form.addEventListener('submit', function(e) {
                    ...
                    if (email !== originalEmail && !emailChangePassword) {
                        e.preventDefault();
                        showToast('error',
                        'Please enter your current password to change the email address');
