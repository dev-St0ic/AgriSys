{{-- resources/views/admin/seedlings/edit.blade.php --}}

@extends('layouts.app')

@section('title', 'Edit Seedling Request - AgriSys Admin')
@section('page-title')
    <div class="d-flex align-items-center">
        <i class="fas fa-edit text-primary me-2"></i>
        <span class="text-primary fw-bold">Edit Seedling Request</span>
    </div>
@endsection
...
@section('content')
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-warning text-dark py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">
                                ...
                                Edit Request - {{ $seedlingRequest->request_number }}
                            </h5>
                            <span class="badge bg-{{ $seedlingRequest->status_color }} text-white">
                                {{ ucfirst(str_replace('_', ' ', $seedlingRequest->status)) }}
                            </span>
                        </div>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('admin.seedlings.update', $seedlingRequest) }}" enctype="multipart/form-data" id="editRequestForm">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('first_name') is-invalid @enderror" 
                                            id="first_name" name="first_name" value="{{ old('first_name', $seedlingRequest->first_name) }}" required>
                                        @error('first_name')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('middle_name') is-invalid @enderror" 
                                            id="middle_name" name="middle_name" value="{{ old('middle_name', $seedlingRequest->middle_name) }}">
                                        @error('middle_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('last_name') is-invalid @enderror" 
                                            id="last_name" name="last_name" value="{{ old('last_name', $seedlingRequest->last_name) }}" required>
                                        @error('last_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select @error('extension_name') is-invalid @enderror" 
                                            ...
                                            <option value="Jr." {{ old('extension_name', $seedlingRequest->extension_name) == 'Jr.' ? 'selected' : '' }}>Jr.</option>
                                            <option value="Sr." {{ old('extension_name', $seedlingRequest->extension_name) == 'Sr.' ? 'selected' : '' }}>Sr.</option>
                                            <option value="II" {{ old('extension_name', $seedlingRequest->extension_name) == 'II' ? 'selected' : '' }}>II</option>
                                            <option value="III" {{ old('extension_name', $seedlingRequest->extension_name) == 'III' ? 'selected' : '' }}>III</option>
                                            <option value="IV" {{ old('extension_name', $seedlingRequest->extension_name) == 'IV' ? 'selected' : '' }}>IV</option>
                                        </select>
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('contact_number') is-invalid @enderror" 
                                            id="contact_number" name="contact_number" value="{{ old('contact_number', $seedlingRequest->contact_number) }}" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                            id="email" name="email" value="{{ old('email', $seedlingRequest->email) }}">
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('barangay') is-invalid @enderror" 
                                            id="barangay" name="barangay" value="{{ old('barangay', $seedlingRequest->barangay) }}" 
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror" 
                                            id="address" name="address" rows="2" required>{{ old('address', $seedlingRequest->address) }}</textarea>
                                        @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control @error('planting_location') is-invalid @enderror" 
                                            id="planting_location" name="planting_location" rows="2">{{ old('planting_location', $seedlingRequest->planting_location) }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control @error('purpose') is-invalid @enderror" 
                                            id="purpose" name="purpose" rows="2">{{ old('purpose', $seedlingRequest->purpose) }}</textarea>
                                        @error('purpose')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control @error('preferred_delivery_date') is-invalid @enderror" 
                                            ...
                                            value="{{ old('preferred_delivery_date', $seedlingRequest->preferred_delivery_date ? $seedlingRequest->preferred_delivery_date->format('Y-m-d') : '') }}" 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if($seedlingRequest->hasDocuments())
                                            <div class="mb-2">
                                                <a href="{{ $seedlingRequest->document_url }}" target="_blank" class="btn btn-sm btn-outline-info">
                                        ...
                                        <small class="text-muted">Upload new file to replace existing. Accepted: PDF, JPG, PNG (Max: 5MB)</small>
                                        @error('document')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="section-card mb-4">
                                <h6 class="section-title">
                                    ...
                                    Edit Items <span class="text-danger">*</span>
                                </h6>
                                    ...
                                    @foreach($categories as $category)
                                        <div class="category-section mb-4">
                                            ...
                                            <div id="category-{{ $category->id }}-items" class="items-list">
                                                @php
                                                    $existingItems = $seedlingRequest->items->where('category_id', $category->id);
                                                @endphp
                                                
                                                @foreach($existingItems as $index => $existingItem)
                                                    <div class="item-row" id="item-row-existing-{{ $existingItem->id }}">
                                                        <div class="row g-3 align-items-end">
                                                            <div class="col-md-7">
                                                                <label class="form-label">Select Item</label>
                                                                <select name="items[existing_{{ $existingItem->id }}][category_item_id]" 
                                                                    ...
                                                                    @foreach($category->items as $item)
                                                                        <option value="{{ $item->id }}" 
                                                                            ...
                                                                            {{ $existingItem->category_item_id == $item->id ? 'selected' : '' }}>
                                                                            {{ $item->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="number" 
                                                                        name="items[existing_{{ $existingItem->id }}][quantity]" 
                                                                        class="form-control" 
                                                                        min="{{ $existingItem->categoryItem->min_quantity ?? 1 }}"
                                                                        value="{{ $existingItem->requested_quantity }}" 
                                                                        required>
                                                                    <span class="input-group-text">{{ $existingItem->categoryItem->unit ?? 'pcs' }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <button type="button" class="btn btn-danger w-100" 
                                                                    onclick="removeItemRow('existing-{{ $existingItem->id }}')">
                        ...
                        @if(in_array($seedlingRequest->status, ['pending', 'under_review', 'rejected']))
                            <form id="deleteForm" method="POST" 
                                action="{{ route('admin.seedlings.destroy', $seedlingRequest) }}" 
                                style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
    ...
    <script>
        ...
        let itemCounter = 1000; // Start high to avoid conflicts with existing items
