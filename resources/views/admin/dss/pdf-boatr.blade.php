...
<body>
    <div class="page">
                ...
                <table class="perf-table">
                    <tr>
                        <td>
                            ...
                            <span
                                class="perf-val">{{ $report['report_data']['performance_assessment']['approval_efficiency'] ?? 'N/A' }}</span>
                        </td>
                        <td>
                            <span class="perf-lbl">Inspection Effectiveness</span>
                            <span
                                class="perf-val">{{ $report['report_data']['performance_assessment']['inspection_effectiveness'] ?? 'N/A' }}</span>
                        </td>
                    </tr>
                </table>
            @endif
        ...
        <div class="section">
            ...
            <p style="font-size:9.5px; margin-bottom:3px;"><strong>Approval Rate:</strong>
                {{ $data['boatr_stats']['approval_rate'] }}%</p>
            <p style="font-size:9.5px; margin-bottom:3px;"><strong>Inspection Rate:</strong>
                {{ $data['boatr_stats']['inspection_rate'] }}%</p>
            <p style="font-size:9.5px; margin-bottom:3px;"><strong>Average Boat Length:</strong>
                {{ $data['boatr_stats']['avg_boat_length'] }}</p>
            <p style="font-size:9.5px;"><strong>Average Engine Power:</strong>
                {{ $data['boatr_stats']['avg_horsepower'] }}</p>
        </div>
            ...
            <table class="two-col-table">
                <tr>
                    <td>
                        ...
                        <ul class="item-list">
                            <li><span class="icon-ok">+</span>Completed:
                                {{ $data['boatr_inspection_analysis']['inspections_completed'] }}</li>
                            <li><span class="icon-ok">+</span>Pending:
                                {{ $data['boatr_inspection_analysis']['inspections_pending'] }}</li>
                            <li><span class="icon-ok">+</span>Completion Rate:
                                {{ $data['boatr_inspection_analysis']['completion_rate'] }}%</li>
                        </ul>
                    </td>
                    <td></td>
                </tr>
                        ...
                        <td>
                            ...
                            <ul class="rec-body">
                                @foreach ($report['report_data']['recommendations']['long_term_vision'] as $vision)
                                    <li><span class="badge badge-indigo"
                                            style="margin-right:4px;">LONG</span>{{ $vision }}</li>
                                @endforeach
                            </ul>
                        </td>
                        <td>
        ...
        <div class="section">
            ...
            <p style="font-size:9.5px; margin-bottom:6px;"><strong>Barangays Covered:</strong>
                {{ $data['boatr_by_barangay']['total_barangays_covered'] }}</p>
            <table class="data-table">
                <thead>
                    <tr>
                        <th>Barangay</th>
