    ...
    <div class="page">
                ...
                <table class="perf-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <span
                                class="perf-val">{{ $report['report_data']['performance_assessment']['coverage_adequacy'] ?? 'N/A' }}</span>
                        </td>
                    </tr>
                </table>
            @endif
        ...
        <div class="section">
            ...
            <p style="font-size:9.5px; margin-bottom:3px;"><strong>Approval Rate:</strong>
                {{ $data['fishr_stats']['approval_rate'] }}%</p>
            <p style="font-size:9.5px;"><strong>Rejection Rate:</strong> {{ $data['fishr_stats']['rejection_rate'] }}%
            </p>
        </div>
            ...
            <table class="two-col-table">
                <tr>
                    <td>
                        ...
                        <ul class="item-list">
                            <li><span class="icon-ok">+</span>Male: {{ $data['fishr_demographics']['male_count'] }}
                                ({{ $data['fishr_demographics']['male_percentage'] }}%)</li>
                            <li><span class="icon-ok">+</span>Female: {{ $data['fishr_demographics']['female_count'] }}
        ...
        <div class="section">
            ...
            <p style="font-size:9.5px; margin-bottom:6px;"><strong>Barangays Covered:</strong>
                {{ $data['fishr_by_barangay']['total_barangays_covered'] }}</p>
            <table class="data-table">
                <thead>
                    <tr>
                        <th>Barangay</th>
