    ...
    <div class="page">
                ...
                <table class="perf-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <span
                                class="perf-val">{{ $report['report_data']['performance_assessment']['training_diversity'] ?? 'N/A' }}</span>
                        </td>
                    </tr>
                </table>
            @endif
        ...
        <div class="section">
            ...
            <p style="font-size:9.5px; margin-bottom:3px;"><strong>Approval Rate:</strong>
                {{ $data['training_stats']['approval_rate'] }}%</p>
            <p style="font-size:9.5px;"><strong>Average Processing Time:</strong>
                {{ $data['training_stats']['avg_processing_time'] }}</p>
        </div>
