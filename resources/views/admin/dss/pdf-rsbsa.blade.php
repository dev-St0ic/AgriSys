    ...
    <div class="page">
                ...
                <table class="perf-table">
                    <tr>
                        <td>
                            ...
                            <span
                                class="perf-val">{{ $report['report_data']['performance_assessment']['registration_efficiency'] ?? 'N/A' }}</span>
                        </td>
                        <td>
                            <span class="perf-lbl">Agricultural Diversity</span>
                            <span
                                class="perf-val">{{ $report['report_data']['performance_assessment']['agricultural_diversity'] ?? 'N/A' }}</span>
                        </td>
                    </tr>
                </table>
            @endif
        ...
        <div class="section">
            ...
            <p style="font-size:9.5px; margin-bottom:3px;"><strong>Approval Rate:</strong>
                {{ $data['rsbsa_stats']['approval_rate'] }}%</p>
            <p style="font-size:9.5px; margin-bottom:3px;"><strong>Total Land Area:</strong>
                {{ $data['rsbsa_stats']['total_land_area'] }}</p>
            <p style="font-size:9.5px;"><strong>Average Farm Size:</strong> {{ $data['rsbsa_stats']['avg_land_area'] }}
            </p>
        </div>
            ...
            <table class="two-col-table">
                <tr>
                    <td>
                        ...
                        <ul class="item-list">
                            <li><span class="icon-ok">+</span>Male: {{ $data['rsbsa_demographics']['male_count'] }}
                                ({{ $data['rsbsa_demographics']['male_percentage'] }}%)</li>
                            <li><span class="icon-ok">+</span>Female: {{ $data['rsbsa_demographics']['female_count'] }}
                    ...
                    <td>
                        ...
                        <ul class="item-list">
                            <li><span class="icon-ok">+</span>Small Farms:
                                {{ $data['rsbsa_land_analysis']['small_farms'] }}</li>
                            <li><span class="icon-ok">+</span>Medium Farms:
                                {{ $data['rsbsa_land_analysis']['medium_farms'] }}</li>
                            <li><span class="icon-ok">+</span>Large Farms:
                                {{ $data['rsbsa_land_analysis']['large_farms'] }}</li>
                        </ul>
                    </td>
                </tr>
            </table>
        ...
        <div class="section">
            ...
            <p style="font-size:9.5px; margin-bottom:6px;"><strong>Barangays Covered:</strong>
                {{ $data['rsbsa_by_barangay']['total_barangays_covered'] }}</p>
            <table class="data-table">
                <thead>
                    <tr>
                        <th>Barangay</th>
