            ...
            <div class="modal-body">
                <div class="modal-scroll-content">
                    ...
                    <div class="section">
                        ...
                        <p>These Terms of Service ("Terms") govern your access to and use of AgriSys, a web-based decision support and records management system with integration of large language model for data analysis, accessible through agrisys.site and operated by the City Agriculture Office of San Pedro, Laguna ("City Agriculture Office," "we," "our," or "CAgO").</p>
                        <p>By creating an account, logging in, submitting any registration form, requesting agricultural supplies, or using any feature of AgriSys, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service, the AgriSys Data Privacy Notice, and all applicable laws and regulations of the Republic of the Philippines, including but not limited to:</p>
                        <ul>
                        ...
                        <p>If you do not agree to these Terms, you must immediately cease all use of AgriSys and refrain from creating an account or submitting any information through the system.</p>
                    </div>

                    <!-- 2. Description of Service -->
                    <div class="section">
                        <h2>2. Description of Service</h2>
                        <p>AgriSys is a decision support system developed to modernize and streamline agricultural service delivery for the City Agriculture Office of San Pedro, Laguna. The system provides the following core functionalities:</p>
                        
                        <h4>2.1 Beneficiary Registration and Management</h4>
                        <ul>
                            <li>Registration of farmers, fisherfolk, livestock raisers, and poultry raisers in the Registry System for Basic Sectors in Agriculture (RSBSA)</li>
                            <li>Maintenance of updated beneficiary profiles including agricultural sector, commodity details, farm information, and contact details</li>
                        ...
                        <ul>
                            <li>Online submission of requests for agricultural inputs including seedlings, tilapia fingerlings, and organic fertilizers</li>
                            <li>Processing, approval, and tracking of supply requests by City Agriculture Office personnel</li>
                        ...
                        <ul>
                            <li>Integration of Anthropic's Claude Sonnet 4.5 large language model to analyze agricultural data and generate actionable insights</li>
                            <li>Identification of trends in crop demand, supply distribution patterns, and beneficiary needs</li>
                            <li>Visual dashboards and reports that support evidence-based planning and resource allocation</li>
                        ...
                        <ul>
                            ...
                            <li>Searchable database of beneficiary information, transaction history, and program documentation</li>
                            <li>Compliance with government archival and record retention standards</li>
                        </ul>

                        <p style="margin-top: 15px;">AgriSys is provided primarily for official agricultural programs and services administered by the City Agriculture Office. The system, its features, and availability may be updated, improved, modified, or temporarily suspended from time to time at the sole discretion of the City Agriculture Office for maintenance, security enhancements, policy compliance, or operational requirements.</p>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <ul>
                            <li>Registered farmers, fisherfolk, livestock raisers, and poultry raisers residing in San Pedro, Laguna</li>
                            <li>Individuals or organizations eligible for agricultural programs administered by the City Agriculture Office</li>
                            <li>Representatives authorized to act on behalf of eligible beneficiaries (with proper documentation)</li>
                        </ul>
                        <p><strong>City Agriculture Office Personnel:</strong></p>
                        <ul>
                            <li>Admin Users: City Agriculturists and designated staff responsible for processing requests and managing beneficiary records</li>
                            <li>SuperAdmin Users: City Head Agriculturist and authorized administrators with system-wide configuration capabilities</li>
                        </ul>
                        <p>Minors (individuals under 18 years of age) may only register with the consent and supervision of a parent or legal guardian.</p>

                        <h4>3.2 Account Creation and Verification</h4>
                        <p>To create an account, you must provide accurate, complete, and current personal information, submit valid government-issued identification, and agree to the processing of your personal data in accordance with the AgriSys Data Privacy Notice.</p>

                        <h4>3.3 Account Security and Confidentiality</h4>
                        <p>You are solely responsible for maintaining the confidentiality and security of your username, password, and any other login credentials. You agree not to share your account credentials with any other person or entity. The City Agriculture Office is not liable for any loss, damage, or unauthorized access resulting from your failure to safeguard your account credentials.</p>

                        <h4>3.4 Accuracy and Updates of Information</h4>
                        <p>You agree to provide truthful, accurate, and complete information in all submissions and promptly update your account information when changes occur. Failure to maintain accurate information may result in delays in service delivery, denial of supply requests, or suspension of your account.</p>
                    </div>

                    <!-- 4. Acceptable Use -->
                    <div class="section">
                        <h2>4. Acceptable Use</h2>
                        <p>You agree to use AgriSys only for lawful purposes and in connection with legitimate agricultural services, programs, and transactions administered by the City Agriculture Office of San Pedro, Laguna.</p>

                        <h4>4.1 Prohibited Activities</h4>
                        <p><strong>Unauthorized Access and Security Violations:</strong></p>
                        <ul>
                            <li>Attempting to gain unauthorized access to any part of AgriSys or other user accounts</li>
                            <li>Bypassing, disabling, or interfering with security features, authentication mechanisms, or access controls</li>
                            <li>Probing, scanning, or testing the system for vulnerabilities without prior written authorization</li>
                            <li>Using automated tools, scripts, bots, or spiders to access, scrape, or extract data from AgriSys</li>
                        </ul>

                        <p><strong>False Information and Fraud:</strong></p>
                        <ul>
                            <li>Submitting false, misleading, fraudulent, or deceptive information in registration forms or supply requests</li>
                            <li>Misrepresenting your identity, agricultural sector, farm ownership, or eligibility status</li>
                            <li>Making duplicate requests or registrations to obtain more than your fair share of agricultural supplies</li>
                            <li>Falsifying documents, signatures, or supporting evidence submitted to the City Agriculture Office</li>
                        </ul>

                        <p><strong>System Interference and Misuse:</strong></p>
                        <ul>
                            <li>Uploading, transmitting, or distributing viruses, malware, ransomware, or any malicious code</li>
                            <li>Interfering with the normal operation, performance, or functionality of AgriSys or its host networks</li>
                            <li>Overloading the system with excessive requests or traffic that may degrade service availability</li>
                            <li>Modifying, reverse engineering, decompiling, or attempting to extract source code from AgriSys</li>
                        </ul>

                        <p><strong>Data Misuse and Privacy Violations:</strong></p>
                        <ul>
                            <li>Accessing, collecting, copying, or using personal data of other beneficiaries obtained through AgriSys for unauthorized purposes</li>
                            <li>Disclosing, sharing, selling, or distributing personal data to third parties without proper authorization</li>
                            <li>Using any data obtained from AgriSys for unauthorized commercial activities, political campaigns, or marketing</li>
                        </ul>

                        <p><strong>Impersonation and Misrepresentation:</strong></p>
                        <ul>
                            <li>Impersonating City Agriculture Office personnel, government officials, or other beneficiaries</li>
                            <li>Creating accounts using another person's identity or information without their consent</li>
                        </ul>

                        <p>The City Agriculture Office reserves the right to monitor system usage, conduct audits, and investigate suspected violations. Evidence of prohibited activities may result in account suspension, termination, legal action, and reporting to appropriate law enforcement or regulatory authorities.</p>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <p>Use of AgriSys involves the collection, storage, processing, and analysis of personal and sensitive personal information for beneficiary registration, agricultural service delivery, supply management, training coordination, decision support analytics, and compliance reporting.</p>
                        <p>By using AgriSys, you acknowledge and consent that your personal data will be processed in accordance with the AgriSys Data Privacy Notice and Republic Act No. 10173 (Data Privacy Act of 2012), its Implementing Rules and Regulations, and all relevant issuances of the National Privacy Commission.</p>

                        <h4>5.2 Confidentiality Obligations for Authorized Personnel</h4>
                        <p>If you are a City Agriculture Office staff member granted access to beneficiary data, supply records, or other confidential information through AgriSys, you agree to use such data solely for official purposes related to your assigned duties and responsibilities, maintain strict confidentiality, and report any suspected data breaches immediately to the Data Protection Officer.</p>
                        <p>Unauthorized disclosure or misuse of personal data is a violation of these Terms of Service and may result in disciplinary action, account termination, and legal consequences under the Data Privacy Act of 2012.</p>
                        ...
                        <ul>
                            <li><strong>Anthropic (Claude Sonnet 4.5):</strong> For large language model analytics and prescriptive decision support insights</li>
                        ...
                        <p>These service providers are selected based on their security standards and compliance with data protection regulations. The City Agriculture Office ensures that appropriate data processing agreements are in place to safeguard your information.</p>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <p>AgriSys, including its software architecture, source code, database design, user interface, decision support features, prescriptive analytics capabilities, system documentation, and all related intellectual property, is owned and controlled by the City Agriculture Office of San Pedro, Laguna and/or its authorized developers (Polytechnic University of the Philippines - San Pedro Campus research team: Prias, Jasper T.; Reyes, Jerald G.; Saez, Blanca Alexis C.; Viado, Arvy M.).</p>

                        <h4>6.2 Limited License to Use</h4>
                        <p>You are granted a limited, non-exclusive, non-transferable, revocable right to access and use AgriSys solely for authorized purposes. <strong>Beneficiaries:</strong> To register, submit supply requests, apply for training programs, and view transaction history. <strong>City Agriculture Office Personnel:</strong> To perform official duties related to beneficiary management, supply distribution, and program administration.</p>

                        <h4>6.3 Restrictions on Use</h4>
                        <p>You may not reproduce, duplicate, copy, modify, adapt, distribute, sublicense, or reverse engineer any part of AgriSys. <strong>Exception:</strong> City Agriculture Office personnel may reproduce system-generated reports, dashboards, and analytics as necessary for official reporting purposes, provided that such use is consistent with data privacy obligations.</p>

                        <h4>6.4 User-Supplied Data</h4>
                        <p>You retain ownership of the personal information, documents, and data that you submit through AgriSys. However, by submitting this information, you grant the City Agriculture Office a non-exclusive, royalty-free license to use, process, store, and analyze such data for the purposes stated in the AgriSys Data Privacy Notice and these Terms of Service.</p>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <p>The City Agriculture Office may, at its sole discretion and without prior notice, temporarily suspend or permanently discontinue all or part of AgriSys for reasons including changes in government policy, legal or regulatory requirements, security threats, or operational inefficiencies. In the event of permanent discontinuation, the City Agriculture Office will, where feasible, provide reasonable notice.</p>

                        <h4>7.5 No Liability for Service Interruptions</h4>
                        <p>The City Agriculture Office shall not be liable for any loss, damage, inconvenience, delay, or inability to access AgriSys resulting from system downtime, maintenance, third-party service provider outages, or force majeure events.</p>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <p>To the maximum extent permitted by law, AgriSys is provided on an "as is" and "as available" basis without warranties of any kind, either express or implied. The City Agriculture Office makes no representation or warranty that AgriSys will meet your specific requirements or expectations, or that any defects or errors will be corrected.</p>

                        <h4>8.2 Limitation of Liability</h4>
                        <p>To the fullest extent permitted by applicable law, the City Agriculture Office, its officers, employees, staff, authorized developers, technology partners, and service providers shall not be liable for any direct, indirect, incidental, consequential, special, punitive, or exemplary damages arising from or in connection with your use or inability to use AgriSys, errors in data or analytics, delays in processing, unauthorized access to your account, or reliance on system-generated insights without independent verification.</p>

                        <h4>8.3 Professional Judgment and Verification</h4>
                        <p>Prescriptive analytics, decision support recommendations, and insights generated by AgriSys using Anthropic's Claude Sonnet 4.5 large language model are intended to assist City Agriculture Office personnel in planning and resource allocation. However, all analytics, reports, and recommendations remain subject to professional judgment, field validation, and compliance with applicable agricultural program guidelines. City Agriculture Office personnel are responsible for independently verifying the accuracy and appropriateness of system-generated insights before making operational decisions.</p>

                        <h4>8.4 Indemnification</h4>
                        <p>You agree to indemnify, defend, and hold harmless the City Agriculture Office, its officers, employees, authorized developers, and service providers from and against any claims, liabilities, damages, losses, costs, and expenses arising from or related to your violation of these Terms of Service, your submission of false or fraudulent information, your unauthorized use of AgriSys, or your misuse of personal data.</p>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <p>The City Agriculture Office may, at its sole discretion and without prior notice, suspend, restrict, or permanently terminate your access to AgriSys if you violate any provision of these Terms of Service, engage in prohibited activities, submit false information, are found to be ineligible for agricultural programs, or if legal, regulatory, or security concerns require immediate action.</p>

                        <h4>9.2 Termination by You</h4>
                        <p>You may request termination of your account at any time by contacting the City Agriculture Office Data Protection Officer. Upon voluntary termination, your access to AgriSys will be revoked and you will no longer be able to submit supply requests or access system features.</p>

                        <h4>9.3 Effect of Termination</h4>
                        <p>Upon termination of your account, you must immediately cease all use of AgriSys. Your right to use the system and any licenses granted under these Terms of Service will automatically terminate. Certain personal data and transaction records may continue to be retained in accordance with Republic Act No. 9470, the City Agriculture Office's 5-year data retention policy, and legal requirements for audit, compliance, and program monitoring purposes.</p>

                        <h4>9.4 Survival of Terms</h4>
                        <p>The following provisions shall survive termination of your account: Sections 5 (Data, Privacy, and Confidentiality), 6 (Intellectual Property), 8 (Limitation of Liability), and 10 (Governing Law).</p>
                    </div>

                    <!-- 10. Governing Law and Dispute Resolution -->
                    <div class="section">
                        <h2>10. Governing Law and Dispute Resolution</h2>
                        <p>These Terms of Service, and any disputes arising out of or in connection with your use of AgriSys, shall be governed by and construed in accordance with the laws of the Republic of the Philippines, without regard to conflict of law principles.</p>
                        <p>Any dispute, controversy, or claim arising out of or relating to these Terms of Service, the AgriSys Data Privacy Notice, or your use of AgriSys shall, as far as practicable, be resolved amicably through direct consultation and coordination with the City Agriculture Office or mediation or facilitated dialogue with the involvement of the City Government of San Pedro, Laguna.</p>
                        <p>You agree that any legal action or proceeding related to these Terms of Service or AgriSys shall be brought exclusively in the courts of San Pedro, Laguna, or such other courts as may have proper jurisdiction under Philippine law.</p>
                    </div>

                    <!-- 11. Changes to Terms of Service -->
                    <div class="section">
                        <h2>11. Changes to Terms of Service</h2>
                        <p>The City Agriculture Office reserves the right to revise, modify, update, or replace these Terms of Service at any time to reflect changes in applicable laws, updates to AgriSys features, improvements in security and privacy, or clarifications based on user feedback or legal review.</p>
                        <p>All updates to these Terms of Service will be posted on the AgriSys platform (agrisys.site) and may also be posted on the official website of the City Agriculture Office of San Pedro, Laguna. The "Last Updated" date will reflect the most recent revision.</p>
                        <p>Continued use of AgriSys after the posting of updated Terms of Service constitutes your acceptance of and agreement to be bound by the revised terms. If you do not agree with the changes, you must immediately cease using AgriSys and may request termination of your account.</p>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <p>By creating an account, logging in, or using any feature of AgriSys, you acknowledge that:</p>
                        <ol>
                            <li>You have read, understood, and agree to be bound by these Terms of Service in their entirety</li>
                            <li>You have read and understood the AgriSys Data Privacy Notice and consent to the collection, use, storage, and sharing of your personal data as described therein</li>
                            <li>You agree to comply with all applicable laws, regulations, and policies while using AgriSys</li>
                            <li>You understand that the City Agriculture Office may modify these Terms at any time, and that continued use of AgriSys constitutes acceptance of such modifications</li>
                            <li>You understand your responsibilities regarding account security, accuracy of information, acceptable use, and confidentiality obligations</li>
                            <li>You acknowledge the limitations of liability and disclaimers set forth in these Terms</li>
                        </ol>
                        <p>If you do not agree with any part of these Terms of Service or the AgriSys Data Privacy Notice, you must not use AgriSys.</p>
                    </div>

                    <div class="section footer-section">
                        <p style="text-align: center; font-style: italic;">Thank you for using AgriSys. The City Agriculture Office of San Pedro, Laguna is committed to modernizing agricultural service delivery and supporting the livelihoods of our local farmers, fisherfolk, and livestock raisers through secure, efficient, and data-driven solutions.</p>
                        <p style="text-align: center; color: #999; font-size: 0.9em;">Effective Date: December 2025 | Last Updated: December 2025</p>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content privacy-modal-content">
            ...
            <div class="modal-body">
                <div class="modal-scroll-content">
                    ...
                    <div class="section">
                        <h2>Introduction</h2>
                        <p>We, at the City Agriculture Office of San Pedro, Laguna, protect the privacy of your personal and sensitive personal information ("personal data") and commit to comply with the Republic Act No. 10173 or the Data Privacy Act ("DPA"), its Implementing Rules and Regulations ("IRR"), and other relevant issuances of the National Privacy Commission. Our goal is to protect your personal data on the channels you interact with us – through the AgriSys platform (agrisys.site), our office premises, physical and digital forms submitted, and other service delivery touchpoints.</p>
                        <p>This Privacy Notice outlines our approach on how we protect your privacy and explains the purpose and legal basis for the processing of personal data that the City Agriculture Office collects from you through AgriSys, the measures in place to protect your data privacy, and the rights that you may exercise in relation to such information.</p>
                    </div>

                    <!-- Why We Collect and Process Personal Data -->
                    <div class="section">
                        <h2>Why We Collect and Process Personal Data</h2>
                        <p>In general, the City Agriculture Office collects, uses and discloses personal data for the following purposes:</p>
                        <ol>
                            <li>To register and maintain an updated database of farmers, fisherfolk, livestock raisers, and poultry raisers in San Pedro City for the Registry System for Basic Sectors in Agriculture (RSBSA)</li>
                            <li>To process and manage requests for agricultural supplies including seedlings, fertilizers, fingerlings, fruit-bearing trees, and organic fertilizers</li>
                            <li>To monitor agricultural supply inventory levels and generate alerts for timely restocking and equitable distribution</li>
                            <li>To process applications for training programs, seminars, agricultural fairs, and capacity-building activities</li>
                            <li>To generate prescriptive analytics and decision support insights using large language model technology to identify trends in crop demand, supply distribution, and beneficiary needs</li>
                            <li>To conduct comprehensive stakeholder analysis and needs prioritization for agricultural programs</li>
                            <li>To respond to court orders, instructions and requests from authorities including regulatory, governmental, and law enforcement</li>
                            <li>To discharge our mandate pursuant to Philippine laws, Local Government Code provisions, and Department of Agriculture programs</li>
                            <li>To respond to, process and handle your queries, requests, feedback, suggestions and complaints</li>
                            <li>To conduct studies and research for the purpose of reviewing, developing and improving our provision of agricultural services</li>
                            <li>To prepare reports required by the Local Government Unit, Department of Agriculture, and other government agencies</li>
                            <li>To prevent, detect, investigate fraud and manage the safety and security of our premises and digital systems including system activity logs and access controls</li>
                        </ol>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <p>The types of personal data we collect and share depend on the means by which it was collected and your interactions with AgriSys. This may include, among others:</p>
                        
                        <h4>Personal Information</h4>
                        <ol>
                            <li>Basic personal information like your name, date of birth, sex/gender, marital status, and citizenship, including supporting documents such as government-issued ID details (front and back images)</li>
                            <li>Your contact details like your complete address, barangay, mobile number, and email address (if available)</li>
                            <li>Agricultural profile information including your sector, primary commodity or crop, farm location and size, type of farming or fishing activity, and livestock and poultry inventory</li>
                            <li>Supporting documents that verify your status as a farmer, fisherfolk, livestock raiser, or poultry raiser (e.g., certificates, permits, land titles, barangay certifications)</li>
                            <li>Transaction records including supply requests, quantities and types of agricultural inputs requested, request dates and approval status, distribution records and acknowledgment receipts</li>
                            <li>Training and seminar participation records, agricultural fair and community event attendance</li>
                            <li>Specimen signatures on acknowledgment receipts and official forms</li>
                            <li>Images via CCTV and other similar recording devices which may be observed when visiting our office and/or using our facilities</li>
                        </ol>

                        <h4>Technical Information</h4>
                        <p>We collect non-personal identification information about users whenever they interact with AgriSys for security and analytics purposes. Non-personal identification information may include IP address, browser type and version, device type (desktop, mobile, tablet), access timestamps, and other technical information used as the means of connection, such as operating system. This type of information cannot be used to identify individual visitors unless necessary for security investigations.</p>
                    </div>

                    <!-- How We May Share Your Data -->
                    <div class="section">
                        <h2>How We May Share Your Data</h2>
                        <p>The City Agriculture Office does not and will not share your personal data with third parties unless necessary for the accomplishment of the above-mentioned purposes and unless you give your consent thereto. Such third parties may include other departments of the San Pedro City Government, agents, outsourced service providers, and other third parties.</p>

                        <h4>Government Agencies</h4>
                        <p>Our third parties include other government agencies/bodies from the executive, legislative and judicial branches of government, including the Department of Agriculture, Philippine Statistics Authority, and other national agencies for statistical reporting, policy development, and program monitoring.</p>

                        <h4>Technology Service Providers</h4>
                        <p>We engage outsourced service providers to achieve utmost support in delivering services to you. AgriSys utilizes the following technology service providers:</p>
                        <ol>
                            <li><strong>Anthropic (Claude Sonnet 4.5):</strong> For large language model analytics and prescriptive decision support insights</li>
                            <li><strong>Hostinger:</strong> For web hosting and server infrastructure</li>
                            <li><strong>Cloudflare:</strong> For content delivery, security, and DDoS protection</li>
                            <li><strong>Philippine Short Message Service Gateway:</strong> For bulk short message service notifications and alerts</li>
                            <li><strong>Simple Mail Transfer Protocol:</strong> For reliable email transmission and communication</li>
                        </ol>
                        <p>Any personal data shared with third parties shall be covered by the appropriate agreement to ensure that all personal data is adequately safeguarded. This City Agriculture Office does not and will not sell personal data to any third party.</p>
                        <p><strong>Note:</strong> While AgriSys currently does not integrate with other government platforms, future updates may enable data sharing with relevant agencies to improve service coordination. Any such integration will be implemented in accordance with data protection laws, and you will be notified of significant changes to our data sharing practices.</p>
                    </div>

                    <!-- How We Protect Your Data -->
                    <div class="section">
                        <h2>How We Protect Your Data</h2>
                        <p>The City Agriculture Office implements technical, organizational and physical security measures to protect your personal data against loss, misuse, modification, unauthorized or accidental access or disclosure, alteration or destruction. We put the following safeguards in place:</p>
                        <ol>
                            <li>Role-based access control with encrypted login credentials ensuring only authorized City Agriculture Office personnel can access AgriSys</li>
                            <li>Use of a secured server behind a firewall with intrusion detection systems</li>
                            <li>Deployment of encryption on computers and devices, with all passwords encrypted using industry-standard hashing algorithms and secure HTTPS protocols for data transmission</li>
                            <li>Use of antivirus and malware protection with updated security patches</li>
                            <li>Regular automated backups to ensure data can be restored in case of system failure or data loss</li>
                            <li>System activity logs tracking all data access and modifications for audit and accountability purposes</li>
                            <li>Establishment of physical security controls including restricted access to office premises and secure storage of paper records in locked cabinets</li>
                        </ol>
                        <p>Moreover, we restrict access to your personal data only to qualified and authorized City Agriculture Office personnel who hold your personal data with strict confidentiality. We likewise train our employees to properly handle your data and comply with data privacy principles and security protocols.</p>
                        <p>Despite these measures, no system can guarantee absolute security. While we strive to protect your data using industry best practices, we encourage you to safeguard your own account credentials and report any suspected security incidents to our office immediately.</p>
                    </div>

                    <!-- How We Store and Dispose Your Data -->
                    <div class="section">
                        <h2>How We Store and Dispose Your Data</h2>
                        <p>The City Agriculture Office retains and stores your personal data only according to operational needs and in compliance with its legal mandates. Our data retention and disposal policy is in accordance with Republic Act No. 9470 or the National Archives of the Philippines Act and applicable laws. Generally, this City Agriculture Office shall only retain your data for five (5) years after the processing relevant to the purpose has been terminated or after your last transaction with our office.</p>

                        <h4>Extended Retention</h4>
                        <p>However, this City Agriculture Office may retain and store your personal data beyond five years when:</p>
                        <ol>
                            ...
                            <li>You remain an active beneficiary receiving services from the City Agriculture Office</li>
                            <li>When provided by law for legitimate purposes</li>
                        </ol>

                        <h4>Data Disposal</h4>
                        <p>When your personal data is no longer necessary to achieve any of the above-mentioned purposes, this City Agriculture Office destroys, deletes or disposes of the same following the security standards. Digital records are securely deleted from AgriSys databases and backup systems using data erasure methods that prevent recovery. Paper documents and physical records are shredded or incinerated following secure disposal protocols. Data used for statistical or research purposes may be anonymized or de-identified so that it can no longer identify you personally.</p>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <p>You have the right to be informed about how your personal data is being collected, used, and shared. This Privacy Notice serves that purpose.</p>

                        <h4>2. Right to Object</h4>
                        <p>You have the right to object to the processing of your personal data, including processing for direct marketing purposes, subject to limitations when processing is required by law or necessary for the performance of official functions.</p>

                        <h4>3. Right to Access</h4>
                        <p>You have the right to reasonable access to your personal data held by AgriSys, including basic profile information, supply request history, training records, and documents you submitted.</p>

                        <h4>4. Right to Rectify or Correct Erroneous Data</h4>
                        <p>If you believe that your personal data is inaccurate, incomplete, or outdated, you have the right to request correction or update with supporting documentation.</p>

                        <h4>5. Right to Erase or Block</h4>
                        <p>You have the right to request deletion or blocking of your personal data under certain circumstances, subject to limitations when we are required to retain your data for legal compliance, ongoing programs, or to fulfill our mandate as a government office.</p>

                        <h4>6. Right to Secure Data Portability</h4>
                        <p>You have the right to obtain a copy of your personal data in a structured, commonly used, and machine-readable format (e.g., PDF, Excel).</p>

                        <h4>7. Right to be Indemnified for Damages</h4>
                        <p>You have the right to be indemnified for any damages sustained due to inaccurate, incomplete, outdated, false, unlawfully obtained, or unauthorized use of your personal data.</p>

                        <h4>8. Right to File a Complaint</h4>
                        <p>If you believe your data privacy rights have been violated, you have the right to file a complaint with the City Agriculture Office Data Protection Officer or the National Privacy Commission.</p>

                        <h4>How to Exercise Your Rights</h4>
                        <p>To exercise any of these rights, submit a written request to our Data Protection Officer (contact details below). We will respond to your request within a reasonable timeframe, typically within 15 to 30 days, and may require identity verification to protect your data from unauthorized access.</p>
                    </div>

                    <!-- Children's Privacy -->
                    <div class="section">
                        <h2>Children's Privacy</h2>
                        <p>AgriSys is designed for use by adult beneficiaries (18 years and older) who are farmers, fisherfolk, livestock raisers, or their authorized representatives. We do not knowingly collect personal data from minors (individuals under 18 years of age) without proper consent from a parent or legal guardian.</p>
                        <p>If you are under 18 and wish to register as a beneficiary, please ensure that your parent or legal guardian completes the registration on your behalf and consents to the processing of your data.</p>
                        <p>If we become aware that we have collected personal data from a minor without appropriate consent, we will take steps to delete such information promptly.</p>
                    </div>

                    <!-- Changes to the Privacy Notice -->
                    <div class="section">
                        <h2>Changes to the Privacy Notice</h2>
                        <p>The City Agriculture Office may amend this Privacy Notice to reflect relevant updates and ensure conformity with legal and regulatory requirements for processing personal data.</p>
                        ...
                        <p>Your continued use of AgriSys after the posting of updated privacy terms constitutes your acceptance of the revised policy. We encourage you to review this Privacy Notice periodically to stay informed about how we protect your data.</p>
                    </div>

                    <!-- Limitations of This Privacy Notice -->
                    <div class="section">
                        <h2>Limitations of This Privacy Notice</h2>
                        <p>AgriSys may contain links to websites of government departments and other organizations. However, this Privacy Notice applies only to the City Agriculture Office of San Pedro, Laguna and the AgriSys platform.</p>
                        <p>You are encouraged and advised to read the respective privacy notices of other agencies/offices when accessing external platforms or services.</p>
                    </div>

                    <!-- How You May Contact Us -->
                    <div class="section">
                        <h2>How You May Contact Us</h2>
                        <p>For further privacy-related inquiries or complaints, you may contact our Data Protection Officer:</p>
                        ...
                        <strong>Office Hours:</strong> Monday to Friday, 8:00 AM - 5:00 PM (Closed on weekends and public holidays)</p>

                        <h4>For Data Privacy Complaints</h4>
                        <p>For complaints regarding data privacy violations, you may also contact the National Privacy Commission:</p>

                        <p><strong>Website:</strong> https://privacy.gov.ph<br>
                        <strong>Email:</strong> info@privacy.gov.ph or complaints@privacy.gov.ph<br>
                        <strong>Hotline:</strong> (02) 8234-2228</p>
                    </div>

                    <!-- Acknowledgment and Consent -->
                    <div class="section footer-section">
                        <h2>Acknowledgment and Consent</h2>
                        <p>By registering with and using AgriSys, you acknowledge that you have read and understood this Privacy Notice and consent to the collection, use, storage, and sharing of your personal data as described herein.</p>
                        <p style="text-align: center; color: #999; font-size: 0.9em;">Effective Date: December 2025 | Last Updated: December 2025</p>
                    </div>
                </div>
            </div>
