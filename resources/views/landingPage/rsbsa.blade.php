<!-- RSBSA Registration Form (Complete with Dynamic Livelihood Fields) -->
    ...
    <div class="rsbsa-tab-content" id="form" style="display: block;">
        ...
        <form method="POST" action="/apply/rsbsa" enctype="multipart/form-data" id="rsbsa-form">
            ...
            <div class="rsbsa-form-group">
                ...
                <select name="main_livelihood" id="rsbsa-main_livelihood" required onchange="toggleRSBSALivelihoodFields(this)">
            ...
            <!-- FARMER FIELDS -->
            <div id="rsbsa-farmer-fields" style="display: {{ old('main_livelihood') == 'Farmer' ? 'block' : 'none' }};">
                <div class="rsbsa-form-group">
                    ...
                    <select name="farmer_crops" id="rsbsa-farmer_crops" onchange="toggleRSBSAFarmerOtherCrops()">
                        <option value="" disabled {{ old('farmer_crops') ? '' : 'selected' }}>Select Crops/Commodity</option>
                        <option value="Rice" {{ old('farmer_crops') == 'Rice' ? 'selected' : '' }}>Rice</option>
                        <option value="Corn" {{ old('farmer_crops') == 'Corn' ? 'selected' : '' }}>Corn</option>
                        <option value="HVC" {{ old('farmer_crops') == 'HVC' ? 'selected' : '' }}>HVC (High Value Crops)</option>
                        <option value="Livestock" {{ old('farmer_crops') == 'Livestock' ? 'selected' : '' }}>Livestock</option>
                        <option value="Poultry" {{ old('farmer_crops') == 'Poultry' ? 'selected' : '' }}>Poultry</option>
                        <option value="Agri-fishery" {{ old('farmer_crops') == 'Agri-fishery' ? 'selected' : '' }}>Agri-fishery</option>
                        <option value="Other Crops" {{ old('farmer_crops') == 'Other Crops' ? 'selected' : '' }}>Other Crops (specify)</option>
                    </select>
                    @error('farmer_crops')
                        <span style="color: #dc3545; font-size: 0.875rem; display: block; margin-top: 4px;">{{ $message }}</span>
                    @enderror
                ...
                <div id="rsbsa-farmer-other-crops-field" style="display: {{ old('farmer_crops') == 'Other Crops' ? 'block' : 'none' }};">
                    <div class="rsbsa-form-group">
                        <label>Specify Other Crops/Commodity <span style="color: #dc3545; font-weight: bold;">*</span></label>
                        <input type="text" name="farmer_other_crops" placeholder="Example: Vegetables, Fruits"
                ...
                <div class="rsbsa-form-group">
                    ...
                    <input type="text" name="farmer_livestock" placeholder="Example: Chickens (50), Pigs (5)"
                ...
                <div class="rsbsa-form-group">
                    ...
                    <input type="number" name="farmer_land_area" step="0.01" min="0" max="1000"
                ...
                <div class="rsbsa-form-group">
                    ...
                    <select name="farmer_type_of_farm" id="rsbsa-farmer_type_of_farm">
                        <option value="" disabled {{ old('farmer_type_of_farm') ? '' : 'selected' }}>Select Farm Type</option>
                        <option value="Irrigated" {{ old('farmer_type_of_farm') == 'Irrigated' ? 'selected' : '' }}>Irrigated</option>
                        <option value="Rainfed Upland" {{ old('farmer_type_of_farm') == 'Rainfed Upland' ? 'selected' : '' }}>Rainfed Upland</option>
                        <option value="Rainfed Lowland" {{ old('farmer_type_of_farm') == 'Rainfed Lowland' ? 'selected' : '' }}>Rainfed Lowland</option>
                    </select>
                ...
                <div class="rsbsa-form-group">
                    ...
                    <select name="farmer_land_ownership" id="rsbsa-farmer_land_ownership">
                        <option value="" disabled {{ old('farmer_land_ownership') ? '' : 'selected' }}>Select Ownership</option>
                        <option value="Owner" {{ old('farmer_land_ownership') == 'Owner' ? 'selected' : '' }}>Owner</option>
                        <option value="Tenant" {{ old('farmer_land_ownership') == 'Tenant' ? 'selected' : '' }}>Tenant</option>
                        <option value="Lessee" {{ old('farmer_land_ownership') == 'Lessee' ? 'selected' : '' }}>Lessee</option>
                    </select>
                ...
                <div class="rsbsa-form-group">
                    ...
                    <select name="farmer_special_status" id="rsbsa-farmer_special_status">
                        ...
                        <option value="Ancestral Domain" {{ old('farmer_special_status') == 'Ancestral Domain' ? 'selected' : '' }}>Ancestral Domain</option>
                        <option value="Agrarian Reform Beneficiary" {{ old('farmer_special_status') == 'Agrarian Reform Beneficiary' ? 'selected' : '' }}>Agrarian Reform Beneficiary</option>
                        <option value="None" {{ old('farmer_special_status') == 'None' ? 'selected' : '' }}>None</option>
                    </select>
            ...
            <div id="rsbsa-farmworker-fields" style="display: {{ old('main_livelihood') == 'Farmworker/Laborer' ? 'block' : 'none' }};">
                <div class="rsbsa-form-group">
                    <label>Type of Farm Work <span style="color: #dc3545; font-weight: bold;">*</span></label>
                    <select name="farmworker_type" id="rsbsa-farmworker_type" onchange="toggleRSBSAFarmworkerOtherType()">
                        <option value="" disabled {{ old('farmworker_type') ? '' : 'selected' }}>Select Farm Work Type</option>
                        <option value="Land preparation" {{ old('farmworker_type') == 'Land preparation' ? 'selected' : '' }}>Land preparation</option>
                        <option value="Planting/Transplanting" {{ old('farmworker_type') == 'Planting/Transplanting' ? 'selected' : '' }}>Planting / Transplanting</option>
                        <option value="Cultivation" {{ old('farmworker_type') == 'Cultivation' ? 'selected' : '' }}>Cultivation</option>
                        <option value="Harvesting" {{ old('farmworker_type') == 'Harvesting' ? 'selected' : '' }}>Harvesting</option>
                        <option value="Others" {{ old('farmworker_type') == 'Others' ? 'selected' : '' }}>Others (specify)</option>
                    </select>
                ...
                <div id="rsbsa-farmworker-other-type-field" style="display: {{ old('farmworker_type') == 'Others' ? 'block' : 'none' }};">
                    <div class="rsbsa-form-group">
                        <label>Specify Other Farm Work <span style="color: #dc3545; font-weight: bold;">*</span></label>
                        <input type="text" name="farmworker_other_type" placeholder="Specify other farm work"
            ...
            <!-- FISHERFOLK FIELDS -->
            <div id="rsbsa-fisherfolk-fields" style="display: {{ old('main_livelihood') == 'Fisherfolk' ? 'block' : 'none' }};">
                <div class="rsbsa-form-group">
                    <label>Fishing Activity <span style="color: #dc3545; font-weight: bold;">*</span></label>
                    <select name="fisherfolk_activity" id="rsbsa-fisherfolk_activity" onchange="toggleRSBSAFisherfolfOtherActivity()">
                        <option value="" disabled {{ old('fisherfolk_activity') ? '' : 'selected' }}>Select Fishing Activity</option>
                        <option value="Fish capture" {{ old('fisherfolk_activity') == 'Fish capture' ? 'selected' : '' }}>Fish capture</option>
                        <option value="Aquaculture" {{ old('fisherfolk_activity') == 'Aquaculture' ? 'selected' : '' }}>Aquaculture</option>
                        <option value="Gleaning" {{ old('fisherfolk_activity') == 'Gleaning' ? 'selected' : '' }}>Gleaning</option>
                        <option value="Processing" {{ old('fisherfolk_activity') == 'Processing' ? 'selected' : '' }}>Processing</option>
                        <option value="Vending" {{ old('fisherfolk_activity') == 'Vending' ? 'selected' : '' }}>Vending</option>
                        <option value="Others" {{ old('fisherfolk_activity') == 'Others' ? 'selected' : '' }}>Others (specify)</option>
                    </select>
                ...
                <div id="rsbsa-fisherfolk-other-activity-field" style="display: {{ old('fisherfolk_activity') == 'Others' ? 'block' : 'none' }};">
                    <div class="rsbsa-form-group">
                        <label>Specify Other Fishing Activity <span style="color: #dc3545; font-weight: bold;">*</span></label>
                        <input type="text" name="fisherfolk_other_activity" placeholder="Specify other fishing activity"
            ...
            <!-- AGRI-YOUTH FIELDS -->
            <div id="rsbsa-agriyouth-fields" style="display: {{ old('main_livelihood') == 'Agri-youth' ? 'block' : 'none' }};">
                <div class="rsbsa-form-group">
                    ...
                    <select name="agriyouth_farming_household" id="rsbsa-agriyouth_farming_household">
                        <option value="" disabled {{ old('agriyouth_farming_household') ? '' : 'selected' }}>Select</option>
                        <option value="Yes" {{ old('agriyouth_farming_household') == 'Yes' ? 'selected' : '' }}>Yes</option>
                        <option value="No" {{ old('agriyouth_farming_household') == 'No' ? 'selected' : '' }}>No</option>
                    </select>
                ...
                <div class="rsbsa-form-group">
                    ...
                    <select name="agriyouth_training" id="rsbsa-agriyouth_training">
                        <option value="" disabled {{ old('agriyouth_training') ? '' : 'selected' }}>Select</option>
                        <option value="Formal agri-fishery course" {{ old('agriyouth_training') == 'Formal agri-fishery course' ? 'selected' : '' }}>Formal agri-fishery course</option>
                        <option value="Non-formal agri-fishery course" {{ old('agriyouth_training') == 'Non-formal agri-fishery course' ? 'selected' : '' }}>Non-formal agri-fishery course</option>
                        <option value="None" {{ old('agriyouth_training') == 'None' ? 'selected' : '' }}>None</option>
                    </select>
                ...
                <div class="rsbsa-form-group">
                    <label>Agricultural Activity/Program Participation <span style="color: #dc3545; font-weight: bold;">*</span></label>
                    <select name="agriyouth_participation" id="rsbsa-agriyouth_participation">
                        <option value="" disabled {{ old('agriyouth_participation') ? '' : 'selected' }}>Select</option>
                        <option value="Participated" {{ old('agriyouth_participation') == 'Participated' ? 'selected' : '' }}>Participated in agricultural activity/program</option>
                        <option value="Not Participated" {{ old('agriyouth_participation') == 'Not Participated' ? 'selected' : '' }}>Not participated yet</option>
                    </select>
