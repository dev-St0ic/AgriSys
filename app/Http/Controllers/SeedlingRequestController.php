...
use App\Services\SeedlingImportService;
...
class SeedlingRequestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            app(DSSDataService::class)->clearCache(
                now()->format('m'),
                now()->format('Y')
            );
   ...
   public function updateItems(Request $request, SeedlingRequest $seedlingRequest)
{
    ...
    public function importTemplate()
    {
        ...
        $callback = function () {
            ...
            fputcsv($file, ['partially_approved']);
    ...
    // Handling the import of supply requests from uploaded file
    public function import(Request $request)
    {
        ...
        try {
            ...
            Log::info('Seedling import started', [
            ...
            Log::error('Seedling bulk import failed', [
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString(),
            ]);
