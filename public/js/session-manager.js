...
async destroySessionOnServer() {
    ...
    stop() {
        ...
        console.log('⏹️ Session manager stopped');
    },
...
/**
 * Enhanced logout function that handles session cleanup gracefully
 */
function logoutUserSafely() {
    ...
    // Create abort controller for logout request
...
/**
 * Enhanced logout submission with proper error handling
 */
